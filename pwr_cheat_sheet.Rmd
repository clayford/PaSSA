...
Continuing with previous example, it would be of interest if using a mobile device or tablet accounted for at least 5% beyond the variance explained by the model with age, gender and years of education. Call the mobile device or tablet indicator variable set "B" and the others variable set "A". In this case our effect size is 

$$ f^{2} = \frac{0.35 - 0.30}{1 - 0.35}$$

How many subjects would be needed to identify the mobile/tablet contribution to variance explained with 90% power and a signficance level of 0.05?
...
Kabacoff, R. (2011). _R in Action_. Manning.   
