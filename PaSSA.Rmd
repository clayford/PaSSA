...
We can obtain a similar result using simulation. Let's simulate one data set and analysis. The delta is the difference in means (ie, 5.75 - 5 = 0.75). We can use any means, as long as they differ by 0.75. Notice also the constant standard deviation for the two populations.
...
## Post-hoc power analysis: don't do it
