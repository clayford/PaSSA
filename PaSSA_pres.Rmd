...
Determining a sufficient sample size for a statistical test comes down to four _settings_:
...
Determining power for a statistical test comes down to four _settings_:
...
- The one-sided alternative is a stronger assumption and results in a smaller sample size. 

- The two-sided alternative is conservative and results in a larger sample size. Most people stick with this alternative.
