...
- Determine the number of tags on left that convince me the hypothesis is true (_critical region_), or more commonly set a p-value cutoff such as 0.05 (_significance level_)
...
Assume people prefer left 65% of the time and we reject the notion that there is no preference if we witness more than 60% "lefts" at the end of our experiment.

Compare $n=100; (X > 60)$ versus $n=80;  (X > 48)$:
...
## The `pwr` functions and associated statistical tests
