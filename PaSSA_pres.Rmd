...
At the conclusion, we decide whether to reject or fail to reject #1.   
\ 

When we design an experiment and carry out a hypothesis test, we would like to have a high probability (or high power) of rejecting #1 if #2 is true. The usual desired power is at least 0.80, or 80%.
...
Two things I may want to do:  
1. calculate power for a given sample size   
2. calculate sample size for a given power   
...
- Decide which statistical test to use (_one-sample proportion test_ or _binomial test_)
...
## One possible experiment - Why 14?
...
## One possible experiment - calculate power
