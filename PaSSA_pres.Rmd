...
Example: I suspect most people place name tags on the left side of their chest (probably because most people are right handed). I create an experiment to test this hunch. I want my experiment to have a high probability (power) of verifying this hunch _if it's true_.
...
- the number of randomly selected people in my experiment
- the number or proportion of tags on left that convince me the hypothesis is true
- the probability of placing tag on left if my hypothesis is correct
...
Conclude people prefer left if I observe $X \ge 15$ "lefts" in 20 trials. Assume people prefer left 60% of the time.
...
Conclude people prefer left if I observe $X \ge 60$ "lefts" in 100 trials. Assume people prefer left 60% of the time.
...
Conclude people prefer left if I observe $X \ge 60$ "lefts" in 100 trials. Assume people prefer left 65% of the time.
...
No. I could conclude people have no preference even if they truly prefer left 65% of the time. Statisticians call this a _Type II error_, or $\beta$.
...
What if I conclude people prefer left when they actually do not? I have made what is called a _Type I error_. 
