...
Notice the various effect sizes: h, d, f, r, w, f2. These are based on formulas.
...
We will use the first two functions as needed in the examples that follow. This workshop will not cover chi-squared tests.
